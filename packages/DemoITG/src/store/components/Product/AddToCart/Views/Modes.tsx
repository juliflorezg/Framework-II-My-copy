...
export const SlimMode = (props: ICartButton) => {
  ...
  return (
    <Button
      style={[SlimStyles.buttonStyle, slimModeStyles.buttonStyleSlim]}
...
export const DefaultMode = (props: ICartButton) => {
  ...
  return (
    <Button
      style={[defaultStyles.buttonStyle, defaultModeStyles.buttonStyleDefault]}
      onPress={() => props.addToCart()}>
      <Text
...
export const SimpleMode = (props: ICartButton) => {
  ...
  return (
    <Button
      style={[SimpleStyles.buttonStyle, simpleModeStyles.buttonStyleSimple]}
      onPress={() => props.addToCart()}>
      <Text
