...
export const IfConditionalHandler = async ({
    conditions,
    valueToCompare
}: {
    ...
    if (!validation) throw new Error("If Conditional error")
    return validation
};