      ...
      <View style={[productViewStyles.container, defaultStyles.container]}>
        {product ? (
          <>
            ...
            <View
              style={[
                defaultStyles.wrapperBadges,
                productViewStyles.wrapperBadges,
              ]}>
            ...
            {product && product?.skuSpecifications?.length && (

              <SkuSelector product={product} style={style} />
              )
            }

            <ReportHighPrices style={style} product={product}/>
            ...
            {product ? (
              <View
                ...
                <QuantitySelector
                  style={style}
                  product={product}
                  availableQuantityInfo={quantitySelector.availableQuantityInfo}
                  variant={quantitySelector.variant}
                />
                <AddToCartButton
                  text={cart?.text}
                  style={style}
