...
import { ItemProps, ProductCardProps, ProductListProps, QuantitySelectorProps, VariantProductList } from '../types';
...
const ProductList: FC<BlockComponent<ProductListProps>> = ({
  ...
  useEffect(() => {
    componentDidMount();
  }, [params, selectedOrderBy, priceRangeState, perPageParam]);
        ...
        <View style={[defaultStyles.container, Styles?.headerFilter]}>
          ...
          <TouchableOpacity onPress={() => openAction()}>
            <View style={[defaultStyles.container, Styles?.headerFilter]}>
              ...
              <View
                style={[defaultStyles.arrowContainer, Styles?.arrowContainer]}>
                <ChevronDown
                  height={20}
                  width={16}
                  stroke={'#fff'}
